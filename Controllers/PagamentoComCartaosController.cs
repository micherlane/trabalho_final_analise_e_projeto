...
namespace micherlane.Controllers
{
    public class PagamentoComCartaosController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NumeroDoCartao,Bandeira,Id,NomeDoCobrado,InformacoesAdicionais,Discriminator")] PagamentoComCartao pagamentoComCartao)
        {
