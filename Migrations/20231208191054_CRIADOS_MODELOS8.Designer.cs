...
namespace micherlane.Migrations
{
    ...
    [Migration("20231208191054_CRIADOS_MODELOS8")]
    partial class CRIADOS_MODELOS8
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ItemNotaDaVenda", b =>
                {
                    ...
                    b.HasKey("ItemsId", "NotaDaVendasId");

                    b.HasIndex("NotaDaVendasId");

                    b.ToTable("ItemNotaDaVenda");
                });
            ...
            modelBuilder.Entity("ItemNotaDaVenda", b =>
                {
                    b.HasOne("micherlane.Models.Item", null)
                        .WithMany()
